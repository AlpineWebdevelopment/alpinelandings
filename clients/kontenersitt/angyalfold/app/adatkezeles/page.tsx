...
export const metadata: Metadata = {
  title: "Adatkezelési tájékoztató | Konténer Rendelés Angyalföld",
  description:
    "A kontenerrendelesangyalfold.hu weboldal ajánlatkérő űrlapján megadott személyes adatok kezelésére vonatkozó tájékoztató a GDPR szerint.",
    ...
    <main>
      <header className="subhead">
        <div className="wrap">
          ...
          <p className="lead">
            Ez a tájékoztató a <b>kontenerrendelesangyalfold.hu</b> weboldal
      ...
      <section className="article">
        <div className="wrap prose">
          ...
          <p>
            A weboldal „Konténer Rendelés Angyalföld" néven, a XIII. kerületi
