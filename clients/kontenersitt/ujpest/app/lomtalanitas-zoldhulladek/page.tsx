    ...
    <main>
      <header className="subhead">
        <div className="wrap">
          ...
          <h1>Lomtalanítás és zöldhulladék Újpesten</h1>
          <p className="lead">
            Bútor, lom és kerti zöldhulladék elszállítása konténerrel — a IV.
            kerület panelházaiból, társasházaiból és kertes házaiból, egyeztetett
            időpontban.
          </p>
        </div>
      </header>
      ...
      <section className="article">
        <div className="wrap prose">
          ...
          <p>
            A <b>Káposztásmegyeri</b> lakótelep panelházainál a szűkös
            parkolókra, a <b>megyeri</b> kertes házaknál a behajtókra is
            figyelünk, hogy a konténer a lehető legjobb helyre kerüljön.
          </p>

          <h2>Zöldhulladék elszállítás</h2>
          <p>
            Újpest kertes részein — <b>Megyer</b>, <b>Istvántelek</b> — sok a
            kert, így sok a zöldhulladék is. A metszésből és nagytakarításból
            származó zöldhulladékot előzetes egyeztetéssel elszállítjuk:
          </p>
          <ul>
            <li>
