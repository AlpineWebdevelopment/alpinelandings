    ...
    <main>
      <header className="subhead">
        <div className="wrap">
          ...
          <h1>Konténer árak Újpesten</h1>
          <p className="lead">
            Átlátható, m³-alapú árazás — a IV. kerületben <b>{site.m3Price}</b>{" "}
      ...
      <section className="article">
        <div className="wrap prose">
          ...
          <table className="ptable">
            ...
            <tbody>
              <tr>
                <td>Vegyes konténer (8 m³), IV. kerület</td>
                <td>
          ...
          <ul>
            <li>
              <b>Kiszállítás</b> Újpest bármelyik részébe
            </li>
            <li>
