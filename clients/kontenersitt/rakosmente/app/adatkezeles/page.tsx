...
export const metadata: Metadata = {
  title: "Adatkezelési tájékoztató | Konténer Rendelés Rákosmente",
  description:
    "A kontenerrendelesrakosmente.hu weboldal ajánlatkérő űrlapján megadott személyes adatok kezelésére vonatkozó tájékoztató a GDPR szerint.",
    ...
    <main>
      <header className="subhead">
        <div className="wrap">
          ...
          <p className="lead">
            Ez a tájékoztató a <b>kontenerrendelesrakosmente.hu</b> weboldal
      ...
      <section className="article">
        <div className="wrap prose">
          ...
          <p>
            A weboldal „Konténer Rendelés Rákosmente" néven, a XVII. kerületi
