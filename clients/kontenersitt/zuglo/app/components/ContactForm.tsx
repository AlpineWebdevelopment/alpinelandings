...
export default function ContactForm() {
  ...
  if (status === "done") {
    return (
      <div className="c-done" role="status" aria-live="polite">
        <h3>Sikeresen elküldve!</h3>
        <p>
          Köszönjük — hamarosan visszahívjuk az árajánlattal. Ha sürgős, hívjon
          most: <a href={`tel:${site.phoneHref}`}>{site.phoneDisplay}</a>.
        </p>
      </div>
    );
  }
      ...
      <div className="f-row">
        ...
        <div className="f-field">
          ...
          <input
            ...
            id="cim"
            name="helyszin"
            placeholder="pl. Nagy Lajos király útja"
          />
        </div>
      </div>
      <div className="f-field">
        ...
        <textarea
          id="uzenet"
          name="uzenet"
          placeholder="pl. fürdőszoba-felújítás sittje, kb. 3 m³ · mikorra kellene a konténer"
        />
      </div>
