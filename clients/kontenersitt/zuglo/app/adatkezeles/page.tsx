...
export const metadata: Metadata = {
  title: "Adatkezelési tájékoztató | Konténer Rendelés Zugló",
  description:
    "A kontenerrendeleszuglo.hu weboldal ajánlatkérő űrlapján megadott személyes adatok kezelésére vonatkozó tájékoztató a GDPR szerint.",
    ...
    <main>
      <header className="subhero">
        <div className="wrap">
          ...
          <span className="k">Jogi információ</span>
          <h1>Adatkezelési tájékoztató</h1>
          <p className="lead">
            Ez a tájékoztató a{" "}
            <b>kontenerrendeleszuglo.hu</b> weboldal ajánlatkérő űrlapján megadott
            személyes adatok kezeléséről szól, az Európai Parlament és a Tanács
            (EU) 2016/679 rendelete (GDPR) alapján.
          </p>
        </div>
      </header>
      ...
      <section className="article">
        <div className="wrap prose">
          ...
          <p>
            A weboldalt és a rajta megadott adatok kezelését az alábbi
            gazdasági társaság végzi:
          </p>
          ...
          <p>
            A weboldal „Konténer Rendelés Zugló" néven, a XIV. kerületi
          ...
          <ul>
            ...
            <li>
              az adatai törlését kérni („elfeledtetéshez való jog");
            </li>
            ...
            <li>
              a hozzájárulását bármikor visszavonni (ez nem érinti a
